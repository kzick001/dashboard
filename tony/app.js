...
const WeatherPipeline = {
    ...
    processAQI(value) {
        ...
        document.getElementById('aqi-value').className = `font-mono text-2xl font-bold tracking-tighter ${color}`;
        document.getElementById('aqi-desc').textContent = desc;
        document.getElementById('aqi-desc').className = `text-[10px] font-mono mt-4 text-center uppercase tracking-widest font-bold h-6 ${color}`;
